...
//********  when clicking on a marker  ********//
			...
			function info(h){
				...
				$('#left_of_map').append('<h3>'+h[config.name]+'<br><small>Last Update: '+h[config.last_update]+'</small></h3><br><button id="icon-print" button style="width:100px">Export PDF</button>');
